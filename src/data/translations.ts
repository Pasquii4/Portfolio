export const translations: any = {
    es: {
        ...
        about: {
            ...
            freelanceDesc: "Desarrollo de Trading Scanner (FastAPI+WS), dashboards de analítica de apuestas y webs de alto rendimiento en Astro.",
    ...
    en: {
        ...
        about: {
            ...
            freelanceDesc: "Development of Trading Scanner (FastAPI+WS), betting analytics dashboards and high-performance websites in Astro.",
