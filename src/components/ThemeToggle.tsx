...
export default function ThemeToggle() {
    ...
    return (
        <button
            onClick={() => setTheme(isBloomberg ? 'dark' : 'bloomberg')}
            ...
            title="Toggle Theme"
        >
            <div className={`absolute flex items-center gap-2 transition-all duration-500 ease-spring ${!isBloomberg ? 'scale-100 opacity-100 rotate-0' : 'scale-75 opacity-0 -translate-y-4'}`}>
