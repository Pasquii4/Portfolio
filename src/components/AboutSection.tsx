                        ...
                        <div>
                            ...
                            <div className="relative border-l border-[var(--color-border)] ml-3 pl-6 mt-8 flex flex-col gap-8">
                                <div className="relative">
                                    <div className="absolute w-3 h-3 bg-[var(--color-accent)] rounded-full -left-[31px] top-1.5 shadow-[0_0_10px_rgba(var(--color-accent-rgb),0.8)]" aria-hidden />
                                    <h3 className="text-[var(--color-text)] font-bold text-lg leading-tight m-0">{t('about.cfgs')}</h3>
                                ...
                                <div className="relative">
                                    <div className="absolute w-3 h-3 bg-[var(--bg-surface)] border border-[var(--color-border)] rounded-full -left-[31px] top-1.5 transition-colors group-hover:border-[var(--color-accent)]" aria-hidden />
                                    <h3 className="text-[var(--color-text)] font-bold text-lg leading-tight m-0">{t('about.freelance')}</h3>
                                ...
                                <div className="relative">
                                    <div className="absolute w-3 h-3 bg-[var(--bg-surface)] border border-[var(--color-border)] rounded-full -left-[31px] top-1.5 transition-colors group-hover:border-[var(--color-accent)]" aria-hidden />
                                    <h3 className="text-[var(--color-text)] font-bold text-lg leading-tight m-0">{t('about.cfgm')}</h3>
                        ...
                        <div className="pt-2 border-t border-[var(--color-border)]">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <span className="font-mono text-[0.7rem] px-3 py-1.5 rounded-full uppercase font-bold shrink-0 bg-[rgba(var(--color-accent-rgb),0.1)] text-[var(--color-accent)] border border-[rgba(var(--color-accent-rgb),0.3)] flex items-center gap-1.5">
                                    <span className="w-1.5 h-1.5 rounded-full bg-[var(--color-accent)] animate-pulse" aria-hidden /> {t('about.tagAvailable')}
                                </span>
