            ...
            <ScanReveal className="w-[90%] max-w-[1200px] mx-auto">
                ...
                >
                    <div className="flex flex-col gap-6 text-[1.1rem] text-[var(--color-text-secondary)]">
                        ...
                        <p>Actualmente <strong className="text-[var(--color-text)]">abierto a prácticas o proyectos freelance</strong> en el sector FinTech/trading. Si buscas un perfil técnico con visión de producto, escríbeme directamente.</p>
